...
def main() -> int:
    ...
    checks: list[tuple[str, list[str], Path]] = [
        ...
        ("station generation and refill scale benchmark baseline", [sys.executable, "scripts/check_prod4_1_station_scale_benchmark.py", "--skip-prior-regressions"], BACKEND),
        ("candidate-scoped station profiles and request context", [sys.executable, "scripts/check_prod4_2a_scoped_station_profiles.py", "--skip-prior-regressions"], BACKEND),
        ("final-set station candidate projection and source-resolution scope", [sys.executable, "scripts/check_prod4_2b_station_candidate_projection_scope.py", "--skip-prior-regressions"], BACKEND),
        ...
        ("controlled empty local SQLite rebuild", [sys.executable, "scripts/check_prod5_3c_1_controlled_empty_local_rebuild.py", "--skip-prior-regressions"], BACKEND),
        ...
        ("audiobook listener progress resume and long-session contract", [sys.executable, "scripts/check_prod6d_audiobook_listener_contract.py", "--skip-prior-regressions"], PROJECT_ROOT),
        ("whole-app scale soak mobile recovery contract", [sys.executable, "scripts/check_prod6e_scale_soak_mobile_recovery_contract.py", "--skip-prior-regressions"], PROJECT_ROOT),
