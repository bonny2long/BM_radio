...
def main() -> int:
    parser = argparse.ArgumentParser(description='BM-PROD4.2E production multi-bucket vs experimental unified candidate projection A/B benchmark')
    ...
    try:
        ...
        selectors = [('reference', select_intent_station_recording_ids_reference), ('unified', select_experimental_unified_intent_station_recording_ids)]
        ordinal = 0
        ...
        payload = {
            'benchmark': 'BM-PROD4.2E production multi-bucket vs experimental unified candidate projection A/B',
            'production_selector_policy': 'multi_bucket',
            'unified_selector_policy': 'unified_experimental',
