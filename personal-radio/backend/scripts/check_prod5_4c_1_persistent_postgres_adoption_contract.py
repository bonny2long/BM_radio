...
def main() -> int:
    ...
    check("application_row_count" in preflight_source and "separately reviewed data-transfer plan" in preflight_source, "19 populated SQLite blocks zero-data adoption")
    ...
    check("FastAPI" not in function_source(source, "adopt_persistent_target") and "uvicorn" not in source, "28 adopt never starts FastAPI")
