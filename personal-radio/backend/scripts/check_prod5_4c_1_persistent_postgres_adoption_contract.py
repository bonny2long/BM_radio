...
def main() -> int:
    ...
    rollback_source = function_source(source, "validate_rollback_files")
    check('sha256_path(current_env_path) != adopted_hash' in rollback_source and "changed independently" in rollback_source, "31 rollback protects independent env changes")
