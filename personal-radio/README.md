...
Private premium radio, music player, and audiobook bookshelf built from NAS media library. Includes support for manual/smart playlists, radio profiles, music deduplication, and library integrity diagnostics.
