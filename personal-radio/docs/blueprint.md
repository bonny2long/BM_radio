...
Updated: 2026-07-27  
Status: Product direction locked; MVP is functional with radio, playlists, deduplication, and library integrity tools.
...
Create radio queues and manual playlists
Track library integrity for read-only diagnostics
Store thumbs up/down
Store favorites
Store station preferences and radio profiles
Store audiobook progress
Manage music recordings participation/deduplication
...
Library
  Direct music browsing when Bonny wants a specific album, artist, song, discography, or playlist.
...
Tap playlist -> playlist detail and playback
```
...
No ingest scanning
Playlists (Smart & Manual)
Library integrity endpoints
Music deduplication / source participation
```
