...
Updated: 2026-07-27  
Status: Fourth-app source-of-truth addendum after BM Radio reached scanner, playback, playlists, deduplication, and integrity working state.
...
Audiobook progress
Book status
Radio Profiles (Artist, Album, Track tagging)
Music Recordings Participation (Deduplication preference)
...
Manual and Smart Playlists can be created and played.
Queue acts intelligently and can be saved.
Library Integrity provides read-only diagnostics for missing covers, duplicates, and stale scans.
Radio Profiles allow metadata tagging internally.
Recordings Participation handles duplicate track resolution.
Audio playback works.
Library album/artist/playlist artwork appears.
...
```text
Artwork consistency in MiniPlayer, Queue, and Now Playing.
Home screen premium redesign.
Audiobook metadata cleanup.
More complete Bookshelf filtering and simple analytics.
```
...
Archive Assistant moves approved music/audiobooks
  ...
  -> BM Radio generates stations/library/bookshelf/integrity views
  -> Bonny plays media over LAN/Tailscale
  -> BM Radio saves thumbs, favorites, playlists, profiles, deduplication choices, queue history, and audiobook progress
```
...
Playlists
Radio Profiles
Music Recordings (Deduplication / Participation)
Track thumbs
Track favorites
Playback events
Audiobook progress
...
BM Radio plays music and playlists on phone-sized UI.
